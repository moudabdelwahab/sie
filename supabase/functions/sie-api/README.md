...
|---|---|---|
| `/v1/health` | GET | فحص توفر. مفتوح من غير تسجيل دخول. |
...
`verify_jwt = true`، والدالة بتبني عميل Supabase بـ **توكن الطالب نفسه**
مش بـ service role. ده مش تشدد زيادة — ده الشرط عشان الحاجة تشتغل أصلاً:
