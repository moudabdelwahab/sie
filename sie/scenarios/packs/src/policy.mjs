...
export const GENERIC_WORDS = Object.freeze({
    ...
    max: Object.freeze(['entity_browser_version', 'entity_policy_word', 'entity_forgot', 'entity_broke', 'entity_inside', 'entity_works_normally', 'entity_remember_word', 'entity_shared_with_someone', 'entity_strength_word', 'entity_failed_word', 'entity_stuck_word', 'entity_convert_word'])
});
