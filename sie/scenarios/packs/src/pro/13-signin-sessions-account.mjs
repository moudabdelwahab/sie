...
export default {
    ...
    scenarios: [
        S('login_company_member_mode', 'login/account_type/company_member', 'login',
            ...
            { alt: ['entity_company_mode:633 entity_login:156 intent_how_to:211', 'entity_company_mode:610 symptom_login_failed:390'] }),
        ...
        S('signup_username_rules', 'account/signup/username_rules', 'login',
            ...
            { alt: ['entity_username:3 symptom_name_taken:2 entity_signup:1', 'entity_username:480 entity_not_accepted:139 atom_register:139 entity_signup:240'] }),
        ...
        S('forum_post_topic_how', 'community/forum/post_how', 'inquiry',
            ...
            { alt: ['entity_post_topic:610 entity_forum:390'] }),
