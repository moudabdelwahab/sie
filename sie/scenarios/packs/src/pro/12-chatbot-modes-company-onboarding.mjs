...
export default {
    tokens: [
        ...
        T('atom_request', 'طلب', 'request', ['طلب', 'الطلب', 'طلبي']),
    ...
    scenarios: [
        ...
        S('company_onboarding_details_required', 'account/company_onboarding/details_required', 'other',
            ...
            { alt: ['entity_commercial_register:677 entity_subscription:323', 'entity_vat_invoice:2 intent_subscribe:3'] }),
        ...
        S('subscription_expiry_popup_repeats', 'subscription/expiry_popup/repeats', 'billing',
            ...
            { alt: ['entity_expiry_popup:4 entity_every_time:2'] }),
