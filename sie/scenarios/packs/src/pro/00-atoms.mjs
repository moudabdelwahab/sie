...
export default {
    tokens: [
        T('atom_close', 'قفل', 'close', ['اقفل', 'اقفلها', 'اقفله', 'قفلوها', 'قفلوه', 'قفلوا', 'اتقفلت', 'اتقفل', 'يقفل', 'يقفلها', 'تقفل', 'close', 'closed']),
        T('atom_reply', 'رد', 'reply', ['رديت', 'ارد', 'ردي', 'رد', 'بعت رد', 'ابعت رد', 'reply', 'replied', 'يرد', 'يردوا', 'بيرد', 'بيردوا', 'ردوا']),
        T('atom_open_action', 'فتح', 'open', ['فتحت', 'اتفتحت', 'افتح', 'افتحها', 'open', 'opened', 'فتحلي', 'فتحولي', 'اتفتحتلي']),
        T('atom_reopen', 'إعادة فتح', 'reopen', ['اعيد فتحها', 'اعيد فتح', 'افتحها تاني', 'اعادة الفتح', 'اعاده الفتح', 'reopen']),
        T('atom_unchanged', 'مااتغيرش', 'unchanged', ['ماتغيرتش', 'مااتغيرتش', 'متغيرتش', 'ماتغيرش', 'ما اتغيرش', 'ما اتغيرتش', 'زي ما هي', 'زي ما هو', 'ثابتة', 'ثابته']),
        T('atom_by_itself', 'لوحده', 'by itself', ['لوحدها', 'لوحده', 'من نفسها', 'من نفسه', 'تلقائي', 'تلقائيا', 'by itself']),
        T('atom_by_mistake', 'بالغلط', 'by mistake', ['بالغلط', 'بالخطأ', 'بالخطا', 'غلط مني', 'غلط', 'الغلط']),
        T('atom_similar', 'مشابه', 'similar', ['مشابهة', 'مشابهه', 'مشابه', 'زيها', 'شبهها', 'similar', 'نفس الموضوع']),
        ...
        T('atom_member', 'عضو في الفريق', 'team member', ['موظف', 'عضو', 'الاعضاء', 'member', 'teammate']),
