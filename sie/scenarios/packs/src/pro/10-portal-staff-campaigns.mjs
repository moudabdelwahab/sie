 ...
 *
 * Facts: company-tickets.js (customers' stream: read + reply, close/reopen in
 * scope — Mad3oom migration 034); create-subdomain.html (portal logo PNG/JPG/SVG, up to 2MB,
...
export default {
    ...
    scenarios: [
        S('portal_logo_upload', 'widget/portal_branding/logo', 'other',
            ...
            { alt: ['entity_logo:3 entity_my_portal:3', 'entity_profile_picture:610 entity_subdomain:390'] }),
        ...
        S('support_staff_complaint', 'support/staff_conduct/complaint', 'other',
            ...
            'entity_staff_complaint:860 atom_support:139',
        ...
        S('support_thank_specific_agent', 'support/staff_conduct/praise_agent', 'inquiry',
            ...
            'intent_thank_agent:610 entity_agent:390',
        ...
        S('campaign_sent_by_mistake', 'whatsapp/campaign/sent_by_mistake', 'whatsapp',
            ...
            'entity_campaign:323 atom_by_mistake:139 entity_whatsapp:268 intent_cancel:268',
