...
export default {
    ...
    scenarios: [
        ...
        S('security_2fa_code_rejected_clock', 'security/2fa/code_rejected_time_sync', 'login',
            ...
            'entity_2fa:3 symptom_rejected:2 entity_device_clock:1',
            ...
            { alt: ['entity_device_clock:3 entity_2fa:3'] }),
        S('login_reset_link_expired_or_used', 'login/password_reset/link_invalid', 'login',
            ...
            'entity_reset_link:2 entity_password:2 symptom_expired:2',
            ...
            { alt: ['entity_reset_link:2 entity_password:2 symptom_already_registered:2'] }),
