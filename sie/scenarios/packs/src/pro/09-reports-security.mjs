...
export default {
    ...
    scenarios: [
        ...
        S('security_2fa_code_rejected_clock', 'security/2fa/code_rejected_time_sync', 'login',
            ...
            'entity_2fa:390 symptom_rejected:390 entity_device_clock:220',
        ...
        S('login_reset_link_expired_or_used', 'login/password_reset/link_invalid', 'login',
            ...
            'entity_reset_link:487 entity_password:290 symptom_expired:223',
            ...
            { alt: ['entity_reset_link:533 entity_password:290 symptom_already_registered:178'] }),
