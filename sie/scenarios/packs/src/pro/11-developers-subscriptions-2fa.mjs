...
export default {
    tokens: [
        ...
        T('entity_trust_device', 'الثقة في الجهاز', 'trust this device', ['ثق بهذا الجهاز', 'الثقه في الجهاز', 'افتكر الجهاز', 'الجهاز ده', 'trust this device']),
    ...
    scenarios: [
        S('api_secret_lost_after_creation', 'api/key/secret_lost', 'technical',
            ...
            'entity_one_time_secret:3 trigger_lost_something:2 atom_where:1',
            ...
            { alt: ['entity_one_time_secret:3 entity_key_word:2 intent_recover:1'] }),
        S('api_key_created_values_not_shown', 'api/key/created_values_not_shown', 'technical',
            ...
            'symptom_values_not_shown:4 entity_key_word:1',
        ...
        S('api_credential_type_choice', 'api/key/credential_type_choice', 'inquiry',
            ...
            'entity_bearer_token:3 intent_compare:2 entity_key_word:1',
            ...
            { alt: ['entity_bearer_token:3 entity_one_time_secret:2 entity_key_word:1'] }),
        S('api_key_expiry_limit', 'api/key/expiry_limit', 'technical',
            ...
            'entity_key_word:2 entity_expiry_setting:3 symptom_rejected:1',
            ...
            { alt: ['entity_key_word:2 entity_date_notes:3 symptom_rejected:1'] }),
        ...
        S('mcp_close_ticket_refused', 'integration/mcp_tool/close_ticket_refused', 'technical',
            ...
            'entity_mcp_tool:2 atom_close:3 entity_ticket:1',
            ...
            { alt: ['entity_ai_client:3 atom_close:3 entity_ticket:1 symptom_rejected:1'] }),
        S('mcp_cancel_active_subscription_refused', 'integration/mcp_tool/cancel_active_refused', 'technical',
            ...
            'entity_mcp_tool:2 atom_cancel:3 entity_subscription:1',
        ...
        S('subscription_request_already_pending', 'subscription/request/already_pending', 'billing',
            ...
            'entity_review_state:3 entity_subscription:2 symptom_rejected:1',
            ...
            { alt: ['symptom_pending:3 intent_subscribe:2 entity_subscription:1'] }),
        S('subscription_early_renewal_days_kept', 'subscription/renewal/early_extends_from_end', 'billing',
            ...
            'atom_renewal:3 entity_early_timing:3',
        ...
        S('subscription_upgrade_end_date_unchanged', 'subscription/upgrade/merge_keeps_end_date', 'billing',
            ...
            'atom_upgrade:3 entity_date_notes:2 atom_unchanged:2',
            ...
            { alt: ['entity_merge_plan:3 entity_date_notes:2'] }),
        S('subscription_autoreply_bonus_missing', 'subscription/autoreply_bonus/missing', 'billing',
            ...
            'entity_bonus_days:3 entity_auto_reply:2',
        ...
        S('payment_card_page_wallet_coming_soon', 'billing/payment_gateway/method_coming_soon', 'billing',
            ...
            'entity_coming_soon:3 entity_gateway_word:2 entity_payment:1',
        ...
        S('security_2fa_asked_every_login', 'security/2fa/asked_every_time', 'login',
            ...
            'entity_2fa:3 entity_trust_device:2 atom_unchanged:1',
            ...
            { alt: ['entity_2fa:3 entity_every_time:3', 'entity_2fa:3 entity_otp:1 atom_device:2'] }),
        S('security_2fa_use_recovery_code', 'security/2fa/recovery_code_use', 'login',
            ...
            'intent_recover:3 atom_code:2 entity_2fa:1',
            `في صفحة «التحقق بخطوتين» اضغط «استخدام رمز الاستعادة؟» تحت خانة الكود، واكتب واحد من رموز الاستعادة اللي حفظتها وقت التفعيل.\n\nبعد ما تدخل، الأفضل تعيد إعداد التحقق بخطوتين على جهازك الجديد. ولو مش لاقي رموز الاستعادة خالص، قولّي وأفتح تذكرة استرجاع وصول.`,
            `On the "Two-step verification" page, click "Use a recovery code?" under the code field and enter one of the recovery codes you saved when you enabled it.\n\nOnce in, it's best to set up two-step verification again on your new device. If you can't find any recovery codes, tell me and I'll open an access-recovery ticket.`),
        S('security_2fa_too_many_attempts', 'security/2fa/too_many_attempts', 'login',
            ...
            'symptom_too_many_attempts:3 entity_2fa:2',
            `ده حماية مؤقتة بعد كذا كود غلط ورا بعض. استنى كام دقيقة وجرّب تاني بكود جديد من التطبيق (مش القديم).\n\nلو الأكواد بتترفض رغم إنها صح، الغالب إن ساعة الموبايل مش مظبوطة: خلّي التاريخ والوقت «تلقائي» قبل المحاولة الجاية.`,
            `It's a temporary protection after several wrong codes in a row. Wait a few minutes and try again with a fresh code from the app (not the old one).\n\nIf correct codes keep getting rejected, your phone's clock is most likely off: set date & time to "automatic" before the next attempt.`,
            { alt: ['symptom_too_many_attempts:3 entity_otp:2'] }),
        S('login_telegram_code_unavailable', 'login/telegram_otp/unavailable', 'login',
            ...
            'entity_telegram:3 entity_otp:2 symptom_not_working:1',
            `الرسالة دي معناها إن خدمة إرسال الأكواد على تليجرام مش متاحة في اللحظة دي، مش مشكلة في حسابك.\n\nارجع لصفحة الدخول وسجّل دخول من جديد — ده بيبدأ جلسة تحقق جديدة. لو نفس الرسالة ظهرت تاني، قولّي وأفتح تذكرة عشان الفريق يساعدك تدخل.`,
            `That message means the Telegram code delivery isn't available at the moment — not a problem with your account.\n\nGo back to the sign-in page and sign in again — that starts a new verification session. If the same message appears again, tell me and I'll open a ticket so the team can help you in.`,
            { alt: ['entity_telegram:3 atom_code:2 symptom_not_working:1'] })
    ]
};
