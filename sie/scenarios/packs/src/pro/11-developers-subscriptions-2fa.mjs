...
export default {
    tokens: [
        ...
        T('entity_launch_price', 'سعر الإطلاق', 'launch price', ['عرض الاطلاق', 'سعر الاطلاق']),
    ...
    scenarios: [
        S('api_secret_lost_after_creation', 'api/key/secret_lost', 'technical',
            ...
            { alt: ['entity_one_time_secret:516 entity_key_word:139 trigger_lost_something:344', 'entity_one_time_secret:536 entity_key_word:139 intent_recover:323'] }),
        ...
        S('mcp_ai_app_asks_reauthorize', 'integration/mcp/reauthorize_prompt', 'technical',
            ...
            'entity_ai_client:190 intent_reauthorize:810',
        ...
        S('mcp_close_ticket_refused', 'integration/mcp_tool/close_ticket_refused', 'technical',
            ...
            'entity_mcp_tool:340 atom_close:139 entity_ticket:400 symptom_rejected:121',
            ...
            { alt: ['entity_ai_client:190 atom_close:139 entity_ticket:447 symptom_rejected:223'] }),
        S('mcp_cancel_active_subscription_refused', 'integration/mcp_tool/cancel_active_refused', 'technical',
            ...
            { alt: ['entity_ai_client:190 intent_cancel:600 symptom_not_happening:139 entity_mcp_tool:71'] }),
        ...
        S('payment_card_page_wallet_coming_soon', 'billing/payment_gateway/method_coming_soon', 'billing',
            ...
            'entity_coming_soon:604 entity_gateway_word:195 entity_payment:201',
        ...
        S('security_2fa_asked_every_login', 'security/2fa/asked_every_time', 'login',
            ...
            { alt: ['entity_2fa:390 entity_every_time:458 entity_login:153', 'entity_2fa:370 entity_otp:130 atom_device:305 entity_trust_device:195'] }),
        ...
        S('security_2fa_too_many_attempts', 'security/2fa/too_many_attempts', 'login',
            ...
            { alt: ['symptom_too_many_attempts:810 entity_otp:190'] }),
        S('login_telegram_code_unavailable', 'login/telegram_otp/unavailable', 'login',
            ...
            'entity_telegram:340 entity_otp:190 symptom_not_working:300 symptom_name_taken:170',
            ...
            { alt: ['entity_telegram:356 atom_code:139 symptom_name_taken:313 entity_otp:190', 'entity_telegram:356 atom_code:139 symptom_not_working:313 entity_otp:190'] })
    ]
};
