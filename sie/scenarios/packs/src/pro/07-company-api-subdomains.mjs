...
export default {
    ...
    scenarios: [
        ...
        S('api_key_state_meaning', 'api/key/state_meaning', 'api',
            ...
            { alt: ['symptom_expired:190 entity_key_word:139 entity_key_state:670'] }),
        ...
        S('api_mcp_what_is', 'integration/mcp/what_is', 'inquiry',
            ...
            'entity_mcp:356 entity_developers_word:429 intent_how_to:214',
            ...
            { alt: ['entity_mcp:356 entity_api_docs:503 entity_what_is:139'] }),
        ...
        S('subdomain_request_rejected', 'domain/subdomain_request/rejected', 'other',
            ...
            'entity_subdomain:390 symptom_rejected:356 intent_status_check:253',
