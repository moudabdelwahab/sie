...
export default {
    ...
    scenarios: [
        ...
        S('company_profile_edit_admin_only', 'account/company_profile/edit_permission', 'other',
            ...
            { alt: ['entity_company_data:3 symptom_cannot_edit:2', 'atom_company:139 atom_change:139 entity_no_permission_msg:720'] }),
        S('api_create_key_unavailable', 'api/key/create_unavailable', 'api',
            ...
            { alt: ['entity_api_key:390 entity_cannot_make:458 entity_api:153', 'intent_create_key:583 symptom_permission_denied:223 entity_api:194'] }),
        S('api_key_state_meaning', 'api/key/state_meaning', 'api',
            ...
            'entity_key_state:860 entity_key_word:139',
            ...
            { alt: ['symptom_expired:223 entity_key_word:139 entity_key_state:637'] }),
        ...
        S('api_key_scopes_expiry_meaning', 'api/key/scopes_expiry_meaning', 'api',
            ...
            'entity_key_no_scopes:860 entity_key_word:139',
        ...
        S('api_mcp_what_is', 'integration/mcp/what_is', 'inquiry',
            ...
            'entity_mcp:390 entity_developers_word:407 intent_how_to:203',
            ...
            { alt: ['entity_mcp:390 entity_api_docs:470 entity_what_is:139', 'entity_mcp:390 intent_how_to:610'] }),
        S('subdomain_name_format_rejected', 'domain/subdomain_request/name_format', 'other',
            ...
            'entity_subdomain_name_format:458 entity_subdomain:390 symptom_rejected:153',
            ...
            { alt: ['entity_subdomain_name_format:610 entity_subdomain:390'] }),
        S('subdomain_name_taken', 'domain/subdomain_request/name_taken', 'other',
            ...
            'symptom_name_taken:458 entity_subdomain:390 intent_status_check:153',
        ...
        S('subdomain_request_rejected', 'domain/subdomain_request/rejected', 'other',
            ...
            'entity_subdomain:390 symptom_rejected:390 intent_status_check:220',
